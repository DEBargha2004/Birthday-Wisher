...
export const wishTemplateForNoUserPrompt = (
  ...
  return `
  Write a warm and sincere birthday wish for ${recipient_name}, who is celebrating their birthday on ${birth_date}.
  ...
  The message should be signed by ${sender_name}.`
}
...
export const wishTemplateForUserPrompt = (
  ...
  return `
  Write a warm and sincere birthday wish for ${recipient_name}, who is celebrating their birthday on ${birth_date}. Please follow these instructions:
